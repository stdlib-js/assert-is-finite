...
```javascript
import isFinite from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-finite@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-finite/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/assert-is-finite/actions/workflows/test.yml?query=branch:v0.2.0
